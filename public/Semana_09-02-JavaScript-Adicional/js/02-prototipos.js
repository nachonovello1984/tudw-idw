function Jugador(dorsal, nacionalidad, nombre, edad) {
    this.dorsal = dorsal;
...
document.getElementById("llenar-tabla").addEventListener("click", () => {
    ...
    borrarHijos(tBody);
    datos.forEach(j => (tBody.appendChild(j.makeHTMLElement(tBody))));
});